                    ...
                    Rectangle()
                        ...
                        .overlay {
                            if game.grids[index].gridType != .blank && !game.isStop {
                                Image("\(game.grids[index].imageName)")
                                    .resizable()
                                    .scaledToFit()
            ...
            if game.isStop {
                VStack(spacing: 15) {
                    Button {
                        ...
                        (Text(Image(systemName: "arrowtriangle.right.circle")) + Text("  Продовжити"))
                            .bold()
                            .font(.title)
                            .padding()
                            .foregroundColor(.white)
                    ...
                    Button {
                        ...
                        (Text(Image(systemName: "arrow.counterclockwise.circle")) + Text("  Рестарт"))
                            .bold()
                            .font(.title)
                            .padding()
                            .foregroundColor(.white)
