...
struct Grid {
    ...
    var imageName: String {
        switch self.gridType {
        case .blank: return ""
        case .oval: return "prize"//
        case .drop: return "santa"//
        case .app: return "snake"//
        case .circle: return "tree"//
        case .row: return "leftRightArrow"//
        case .column: return "upDownArrow"//
        case .bomb: return "bomb"//
        case .gift: return "star"//
        }
    }
}
